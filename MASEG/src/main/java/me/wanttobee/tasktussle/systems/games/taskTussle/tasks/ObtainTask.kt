package me.wanttobee.tasktussle.systems.games.taskTussle.tasks
...
import me.wanttobee.tasktussle.systems.games.taskTussle.base.TaskIcon
...
class ObtainTask(val itemToObtain : Material, associatedTeam : Team) : ITask(associatedTeam)  {
    override val icon: TaskIcon = TaskIcon(itemToObtain, TTUtil.getRealName(itemToObtain), listOf("${ChatColor.GRAY}obtain this item") )
