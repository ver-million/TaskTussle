...
class Team2(private val teamNumber : Int) {
    ...
    fun setLeaveTeamOnQuit(value : Boolean) : Team2{
        this.leaveTeamOnQuit = value
        return this
    }
    fun setLeaveTeamOnDeath(value : Boolean) : Team2{
        this.leaveTeamOnDeath = value
        return this
    }
    fun setColor(value : ChatColor) : Team2{
        color = value
        return this
    }
