...
open class InteractiveItem {
    ...
    fun isThisItem(i : ItemStack?): Boolean{
        ...
        val iID = metaI.persistentDataContainer.get(MASEGUtil.IDKey, PersistentDataType.INTEGER) ?: return false
        val itemID = item.itemMeta!!.persistentDataContainer.get(MASEGUtil.IDKey, PersistentDataType.INTEGER) ?: return false
        return iID == itemID
    }
