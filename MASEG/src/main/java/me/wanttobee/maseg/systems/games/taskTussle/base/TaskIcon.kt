...
class TaskIcon(private val icon: Material,private val taskTitle : String, private val description : List<String>) {
    private val item : ItemStack = MASEGUtil.itemFactory(Material.BARRIER,"null",null )
    ...
    private fun enchant(yes : Boolean){
        ...
        val meta = item.itemMeta ?: run{
            MASEGPlugin.instance.logger.info("(TaskIcon) ERROR: cant access itemMeta for taskIcon: $taskTitle")
            return
        }
