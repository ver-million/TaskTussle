package me.wanttobee.tasktussle.utils.playerTracker

import me.wanttobee.tasktussle.TTPlugin
import me.wanttobee.tasktussle.TTUtil
import me.wanttobee.tasktussle.utils.interactiveItem.RefreshInteractiveItem
import me.wanttobee.tasktussle.utils.teams.ITeamObserver
...
class PlayerTracker(private val tracking : Team, private val refreshTime: Int, private val focusClosest: Boolean, private val saveWorldLocation: Boolean) : ITeamObserver {
    ...
    private fun giveClosetsItem(p : Player,slot : Int){
        ...
        val realItem = TTUtil.itemFactory(Material.COMPASS, title,memberList )
